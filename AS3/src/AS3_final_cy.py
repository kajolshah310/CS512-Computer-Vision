...
#    lines = []
    ...
    lines = cy3.accu_check(dbins, tbins, accum, thresh)
    ...
    lines2 = cy3.peaks_lines(dbins, tbins, accum, thresh, dpeaks)
    # lines2 = []    
    # for y in range(0, dbins): #d
    #     for x in range(0, tbins): #theta
    ...
    final_lines= cy3.final_lines(dbins, tbins, accum, lines2)        
#     final_lines=[]
#     for line in lines2:
...
def main():
    if len(sys.argv) == 2:
        ...
        filename = "/home/kajol/Desktop/g3.png"
